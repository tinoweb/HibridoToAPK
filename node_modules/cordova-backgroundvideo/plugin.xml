...
<plugin id="cordova-backgroundvideo" version="0.0.22" xmlns="http://apache.org/cordova/ns/plugins/1.0" xmlns:android="http://schemas.android.com/apk/res/android">
  <name>cordova-backgroundvideo</name>
    <description>
        A simple Cordova/Phonegap plugin to capture video and preview onscreen via a transparent overlay without
  ...
  <author>James McCallum and Josh Hayward, support@iclue.io, pavelety@likeapp.ru (background mode for android)</author>
  <repo>https://github.com/pavelety/backgroundvideo</repo>

  <engines>
    <engine name="cordova" version=">=4.0.0" />
  </engines>

  <keywords>video, background, transparent, overlay, recording, camera, cordova, spy, surveillance</keywords>
  ...
  <platform name="android">
    ...
    <source-file src="src/android/io/iclue/backgroundvideo/BackgroundVideo.java" target-dir="src/io/iclue/backgroundvideo" />
    <source-file src="src/android/io/iclue/backgroundvideo/CameraHelper.java" target-dir="src/io/iclue/backgroundvideo" />
    <source-file src="src/android/io/iclue/backgroundvideo/VideoOverlay.java" target-dir="src/io/iclue/backgroundvideo" />
  </platform>
